                    ...
                    <div className="flex flex-col w-full max-w-[400px]">
                        ...
                        <div className="pb-2 flex flex-col gap-10 mt-8">
                            ...
                            <div style={{ borderBottom: '1px solid rgba(0,0,0,0.2)' }} className="pb-3 flex w-full ">
                                <input style={{ outline: 'none' }} type="text" placeholder="Name" />
                            </div>

                            <div style={{ borderBottom: '1px solid rgba(0,0,0,0.2)' }} className="pb-3 flex w-full ">
                                <input style={{ outline: 'none' }} type="text" placeholder="Email or Phone Number" />
                            </div>

                            <div style={{ borderBottom: '1px solid rgba(0,0,0,0.2)' }} className="pb-3 flex w-full ">
                                <input style={{ outline: 'none' }} type="password" placeholder="Password" />
                            </div>

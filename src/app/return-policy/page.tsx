    ...
    return (
        <div className="w-full flex flex-col">
            ...
            <div className="flex flex-col px-3 lg:px-24 mt-10 pb-10 ">
                ...
                <p className="text-gray-700 mb-4">Items must be unused, in their original condition, and in the original packaging. Do not accept tampered packaging.</p>
                ...
                <ol className="list-decimal list-inside text-gray-700 mb-4 space-y-2">
                    <li><span className="font-semibold">Request a Return</span>: Contact our customer service team at <a href="mailto:thepapertrailonlinestore@gmail.com" className="text-blue-500 underline">[Customer Service Email]</a> with your order number, item(s) to be returned, and the reason for the return.</li>
                ...
                <ol className="list-decimal list-inside text-gray-700 mb-4 space-y-2">
                    ...
                    <li><span className="font-semibold">Contact Us</span>: If you still have not received your refund, please contact us at <a href="mailto:thepapertrailonlinestore@gmail.com" className="text-blue-500 underline">[Customer Service Email]</a>.</li>
                </ol>

                <h2 className="text-2xl font-semibold text-gray-800 mt-6 mb-4">Exchanges</h2>
                <p className="text-gray-700 mb-4">We only replace items if they are defective or damaged. If you need to exchange an item for the same product, please contact us at <a href="mailto:thepapertrailonlinestore@gmail.com" className="text-blue-500 underline">[Customer Service Email]</a>.</p>
                ...
                <div className="contact-info text-gray-700">
                    <p><span className="font-semibold">Email:</span> <a href="mailto:thepapertrailonlinestore@gmail.com" className="text-blue-500 underline">[Customer Service Email]</a></p>
                    <p><span className="font-semibold">Phone:</span> +94 71 974 9699</p>
